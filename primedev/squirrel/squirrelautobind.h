		...
		__squirrelautobind CONCAT2(__squirrelautobind, __LINE__)(                                                                                                                   \
			...
			{                                                                                                                                                                       \
				if constexpr (runOnContext & ScriptContext::UI)                                                                                                                     \
					g_pSquirrel<ScriptContext::UI>->AddFuncRegistration(returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext::UI >);         \
				if constexpr (runOnContext & ScriptContext::CLIENT)                                                                                                                 \
					g_pSquirrel<ScriptContext::CLIENT>->AddFuncRegistration(returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext::CLIENT >); \
			},                                                                                                                                                                      \
			[]()                                                                                                                                                                    \
			{                                                                                                                                                                       \
				if constexpr (runOnContext & ScriptContext::SERVER)                                                                                                                 \
					g_pSquirrel<ScriptContext::SERVER>->AddFuncRegistration(returnType, __STR(funcName), argTypes, helpText, CONCAT2(Script_, funcName) < ScriptContext::SERVER >); \
			});                                                                                                                                                                     \
	}                                                                                                                                                                               \
	template <ScriptContext context>                                                                                                                                                \
	SQRESULT CONCAT2(Script_, funcName)(HSquirrelVM * sqvm)
	...
	{                                                                                                                                           \
		__squirrelautobind CONCAT2(__squirrelautobind, __LINE__)(                                                                               \
			...
			{                                                                                                                                   \
				...
				if constexpr (runOnContext & ScriptContext::CLIENT)                                                                             \
					g_pSquirrel<ScriptContext::CLIENT>->AddFuncOverride(__STR(funcName), CONCAT2(Script_, funcName) < ScriptContext::CLIENT >); \
			},                                                                                                                                  \
			[]()                                                                                                                                \
			{                                                                                                                                   \
				if constexpr (runOnContext & ScriptContext::SERVER)                                                                             \
					g_pSquirrel<ScriptContext::SERVER>->AddFuncOverride(__STR(funcName), CONCAT2(Script_, funcName) < ScriptContext::SERVER >); \
			});                                                                                                                                 \
	}                                                                                                                                           \
	template <ScriptContext context>                                                                                                            \
	SQRESULT CONCAT2(Script_, funcName)(HSquirrelVM * sqvm)
