...
class CLimitTimer
{
  public:
	CLimitTimer(void) {}
	CLimitTimer(uint64_t cMicroSecDuration)
	{
...
// -------------------------------------------------------------------------- //
inline CAverageCycleCounter::CAverageCycleCounter(void) : m_nIters(0) {}
...
#define PROFILE_SCOPE(name)                                                                                                                                             \
	...
	{                                                                                                                                                                   \
	  public:                                                                                                                                                           \
		~C##name##ACC()                                                                                                                                                 \
		{                                                                                                                                                               \
			Msg("%-48s: %6.3f avg (%8.1f total, %7.3f peak, %5d iters)\n", #name, GetAverageMilliseconds(), GetTotalMilliseconds(), GetPeakMilliseconds(), GetIters()); \
		}                                                                                                                                                               \
	};                                                                                                                                                                  \
